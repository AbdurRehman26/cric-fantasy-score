...
>
    <template x-for="(toast, index) in toasts" :key="toast.id">
        ...
        >
            <span
                class="group relative flex w-full flex-col items-start border border-gray-200 bg-white shadow-xl transition-all duration-300 ease-out sm:max-w-xs sm:rounded-md dark:border-gray-700 dark:bg-gray-800 dark:text-white"
